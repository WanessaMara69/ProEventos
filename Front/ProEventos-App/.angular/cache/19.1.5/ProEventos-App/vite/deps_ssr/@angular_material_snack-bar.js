...
var OverlayRef = class {
  ...
  _backdropTimeout;
  _backdropClick = new import_rxjs8.Subject();
  _attachments = new import_rxjs8.Subject();
  _detachments = new import_rxjs8.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs8.Subscription.EMPTY;
  ...
  _keydownEvents = new import_rxjs8.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs8.Subject();
  _renders = new import_rxjs8.Subject();
  _afterRenderRef;
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs8.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs8.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs8.Subscription.EMPTY;
  _attachSubscription = import_rxjs8.Subscription.EMPTY;
  _detachSubscription = import_rxjs8.Subscription.EMPTY;
  _positionSubscription = import_rxjs8.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
...
var MatSnackBarRef = class {
  ...
  _afterDismissed = new import_rxjs9.Subject();
  /** Subject for notifying the user that the snack bar has opened and appeared. */
  _afterOpened = new import_rxjs9.Subject();
  /** Subject for notifying the user that the snack bar action was called. */
  _onAction = new import_rxjs9.Subject();
  /**
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _onAnnounce = new import_rxjs9.Subject();
  /** Subject for notifying that the snack bar has exited from view. */
  _onExit = new import_rxjs9.Subject();
  /** Subject for notifying that the snack bar has finished entering the view. */
  _onEnter = new import_rxjs9.Subject();
