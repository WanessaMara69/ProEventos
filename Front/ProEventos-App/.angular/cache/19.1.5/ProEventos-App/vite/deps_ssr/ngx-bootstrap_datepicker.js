...
var BsDatepickerEffects = class _BsDatepickerEffects {
  ...
  setBindings(container) {
    ...
    container.daysCalendar$ = this._store.select((state2) => state2.flaggedMonths).pipe((0, import_operators2.filter)((months) => !!months));
    container.monthsCalendar = this._store.select((state2) => state2.flaggedMonthsCalendar).pipe((0, import_operators2.filter)((months) => !!months));
